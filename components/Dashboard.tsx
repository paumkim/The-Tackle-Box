      ...
      <div className="bridge-body-standard overflow-y-auto custom-scrollbar">
          ...
          <div className="relative z-10 space-y-8 pt-4">
                ...
                <div className="relative z-10 bg-[#fdfbf7] p-4 border border-stone-300 rounded-sm shadow-sm flex items-start gap-4">
                    ...
                    <div className="flex-1">
                        ...
                        <input 
                            ...
                            placeholder="Set the Signal of the Day..."
                            value={morningBrief}
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
              <div className="h-48"><Compass topTask={topPriorityTask} pendingCount={tasks?.length || 0} /></div>
              <div className="h-48"><WeatherGlass /></div>
              <div className="h-48"><ResourceDock /></div>
              <div className="h-48"><PressureGauge /></div>
            </div>
