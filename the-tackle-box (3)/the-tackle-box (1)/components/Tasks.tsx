      ...
      <header className="mb-8 flex justify-between items-end">
        <div>
            <div className="flex items-center gap-2 mb-2">
                <h2 className="text-2xl font-bold text-slate-800">The Deck</h2>
                {activeProjectId && (
      ...
      <AnimatePresence>
        {showProjectSelector && (
            <motion.div 
                ...
                className="mb-6 bg-slate-50 border border-slate-200 rounded-xl p-4 overflow-hidden"
            >
                ...
                <div className="grid grid-cols-2 md:grid-cols-4 gap-3">
                    ...
                    <button 
                        ...
                        className={`p-3 rounded-lg border text-left transition-all ${activeProjectId === null ? 'bg-blue-100 border-blue-300 text-blue-800' : 'bg-white border-slate-200 hover:border-blue-300'}`}
                    >
                    ...
                    {projects?.map(p => (
                        <button 
                            ...
                            className={`p-3 rounded-lg border text-left transition-all ${activeProjectId === p.id ? 'bg-blue-100 border-blue-300 text-blue-800' : 'bg-white border-slate-200 hover:border-blue-300'}`}
                        >
